...
<div class="row g-4">
    ...
    <div class="col-lg-4">
        ...
        <div class="summary-card">
            <label class="summary-label" for="notaSalidaRapida">Observaciones</label>
            <textarea id="notaSalidaRapida" class="form-control" rows="3" placeholder="Motivo u observacion de la salida..." required></textarea>
        </div>
...
function finalizarSalida() {
    ...
    if (!document.getElementById('notaSalidaRapida').value.trim()) {
        Swal.fire({
            icon: 'warning',
            title: 'Observaciones requeridas',
            text: 'Capture una observacion para registrar la salida',
            confirmButtonColor: '#6c757d'
        });
        return;
    }
...
function registrarSalida() {
    ...
    formData.append('nota', document.getElementById('notaSalidaRapida').value.trim());
