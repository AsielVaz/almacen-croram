...
<div class="page-content">
    ...
    <div class="page-container">
        <div class="row row-cols-xxl-4 row-cols-md-2 row-cols-1">
            <div class="col">
                <div class="card"><div class="card-body"><div class="d-flex align-items-start gap-2 justify-content-between"><div><h5 class="text-muted fs-13 fw-bold text-uppercase">Articulos activos</h5><h3 class="mt-2 mb-1 fw-bold"><?= $totalArticulos ?></h3><p class="mb-0 text-muted"><span class="text-nowrap">Catalogo disponible para operaciones</span></p></div><div class="avatar-lg flex-shrink-0"><span class="avatar-title bg-primary-subtle text-primary rounded fs-28"><i class="ri-box-3-line"></i></span></div></div></div></div>
            </div>
            <div class="col">
            ...
            <div class="col">
                <div class="card"><div class="card-body"><div class="d-flex align-items-start gap-2 justify-content-between"><div><h5 class="text-muted fs-13 fw-bold text-uppercase">Ordenes pendientes</h5><h3 class="mt-2 mb-1 fw-bold"><?= $pendientesEntrada + $pendientesSalida ?></h3><p class="mb-0 text-muted"><span class="text-nowrap"><?= $pendientesEntrada ?> entradas y <?= $pendientesSalida ?> salidas</span></p></div><div class="avatar-lg flex-shrink-0"><span class="avatar-title bg-warning-subtle text-warning rounded fs-28"><i class="ri-file-list-3-line"></i></span></div></div></div></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-8">
                <div class="card mb-3">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="header-title mb-0">Ultimas ordenes de entrada</h4>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped align-middle mb-0">
                                ...
                                <?php if (count($ultimasEntradas) === 0): ?>
                                    <tr><td colspan="4" class="text-muted">No hay ordenes de entrada registradas.</td></tr>
                                <?php else: ?>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="header-title mb-0">Ultimas ordenes de salida</h4>
                        <a href="ordenes-salida.php" class="btn btn-sm btn-outline-danger">Ver todas</a>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-striped align-middle mb-0">
                                <thead><tr><th>Folio</th><th>Solicito</th><th>Fecha</th><th>Estatus</th></tr></thead>
                                <tbody>
                                <?php if (count($ultimasSalidas) === 0): ?>
                                    <tr><td colspan="4" class="text-muted">No hay ordenes de salida registradas.</td></tr>
                                <?php else: ?>
            ...
            <div class="col-xl-4">
                <div class="card mb-3">
                    <div class="card-header"><h4 class="header-title mb-0">Atencion inmediata</h4></div>
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <span class="text-muted">Articulos sin stock</span>
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="header-title mb-0">Articulos con menor stock</h4>
                        <a href="articulos.php" class="btn btn-sm btn-outline-secondary">Ver catalogo</a>
                    </div>
                    <div class="card-body">
                        <?php if (count($articulosCriticos) === 0): ?>
                            <p class="text-muted mb-0">No hay articulos para mostrar.</p>
                        <?php else: ?>
