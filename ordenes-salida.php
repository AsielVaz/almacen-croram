...
<body>
    ...
    <div class="wrapper">
        ...
        $ordenes = json_decode($adminOrdenes->listarOrdenesSalida());
        ?>
        <!-- Search Modal -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <div>
                                        <h4 class="header-title mb-1">Ordenes Salida</h4>
                                        <p class="text-muted font-14 mb-0">
                                            Consulta las ordenes de salida de inventario registradas en el sistema.
                                        </p>
                                    </div>

                                    <div>
                                        <a href="ordenes-salida-form.php" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        <?php foreach ($ordenes as $orden) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="ordenes-salida-detalle.php?id=<?= $orden->id ?>" class="btn btn-sm btn-outline-primary">
                                                        Ver detalle
                                                    </a>
                                                </td>
                                            </tr>
